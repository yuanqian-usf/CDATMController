...
import static com.circulardollar.cdatm.TestBase.randomValidCardNumber;
...
public class CardValidatorTest {
    ...
    @Test public void validate_02_01() {
        assertTrue(new CardValidator(ATMConfigurations.newBuilder().build()).validate(new ICard() {
            @Override public String getHolderName() {
                return null;
            }

            @Override public String getCardNumber() {
                return null;
            }

            @Override public String getCVC() {
                return null;
            }

            @Override public String getExpirationDate() {
                return null;
            }
        })
            .isPresent());
    ...
    @Test public void validate_02_02() {
        assertTrue(new CardValidator(ATMConfigurations.newBuilder().build()).validate(
            Card.newBuilder().setCardNumber("").setCvc(randomString())
                .setExpirationDate(randomString()).setHolderName(randomString()).build())
            .isPresent());
    }
    ...
    @Test public void validate_03() {
        assertFalse(new CardValidator(ATMConfigurations.newBuilder().build()).validate(
            Card.newBuilder().setCardNumber(randomValidCardNumber()).setCvc(randomString())
                .setExpirationDate(randomString()).setHolderName(randomString()).build())
            .isPresent());
    }
    ...
    @Test public void validate_04() {
        assertTrue(
            new CardValidator(ATMConfigurations.newBuilder().setMinCardNumberLength(12).build())
                .validate(Card.newBuilder().setCardNumber(randomString()).setCvc(randomString())
                    .setExpirationDate(randomString()).setHolderName(randomString()).build())
                .isPresent());
    }

    @Test public void validate_04_02() {
        assertTrue(
            new CardValidator(ATMConfigurations.newBuilder().setMinCardNumberLength(12).build())
                .validate(Card.newBuilder().setCardNumber("1").setCvc(randomString())
                    .setExpirationDate(randomString()).setHolderName(randomString()).build())
                .isPresent());
    }
